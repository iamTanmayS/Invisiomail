// NavbarComponents/dropdownData.jsx
import React from 'react';
import {
    Database, Globe, Code, Server, Cloud, Monitor, Terminal, Zap,
    Briefcase, Heart, Users, Shield, Bell, HelpCircle, Settings, Bookmark,
    Book, FileText, Phone, Mail, MapPin
} from 'lucide-react';
...
export const dropdownLinks = {
    platform: {
        ...
        image: { src: "https://tinyurl.com/2s42b3cx", alt: "Platform", caption: "Unified database for modern applications" }
    },
    solutions: {
        sections: [
            {
        ...
        image: { src: "https://tinyurl.com/2s42b3cx", alt: "Solutions", caption: "Industry-specific solutions built for scale" }
    },
    resources: {
        sections: [
            {
        ...
        image: { src: "https://tinyurl.com/2s42b3cx", alt: "Resources", caption: "Resources to help you succeed" }
    },
    company: {
        sections: [
            {
        ...
        image: { src: "https://tinyurl.com/2s42b3cx", alt: "Company", caption: "Join us in our mission" }
    }
};